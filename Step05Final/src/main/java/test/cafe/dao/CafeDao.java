...
public class CafeDao {
	//static 필드
		...
		static {
			 ...
			 * 메소드 호출전에 무언가 준비 작업을 하고싶다면 static 블럭 안에서 하면된다.
			 * static 블럭은 해당클래스를 최초로 하용할떄 한번만 실행되기 떄문에
			 * 초기회 작업을 하기에 적당한 블럭이다.
			 */
